...
/**
 * DotsThreeCircleVertical icon component.
 *
 * @example
 * ```tsx
 * <DotsThreeCircleVerticalIcon weight="regular" />
 * ```
 */
export function DotsThreeCircleVerticalIcon(rawProps: IconProps): JSX.Element {
