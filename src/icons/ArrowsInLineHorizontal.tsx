...
/**
 * ArrowsInLineHorizontal icon component.
 *
 * @example
 * ```tsx
 * <ArrowsInLineHorizontalIcon weight="regular" />
 * ```
 */
export function ArrowsInLineHorizontalIcon(rawProps: IconProps): JSX.Element {
