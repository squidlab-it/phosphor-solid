...
/**
 * ArrowsOutLineHorizontal icon component.
 *
 * @example
 * ```tsx
 * <ArrowsOutLineHorizontalIcon weight="regular" />
 * ```
 */
export function ArrowsOutLineHorizontalIcon(rawProps: IconProps): JSX.Element {
