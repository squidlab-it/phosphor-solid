...
/**
 * AlignCenterHorizontalSimple icon component.
 *
 * @example
 * ```tsx
 * <AlignCenterHorizontalSimpleIcon weight="regular" />
 * ```
 */
export function AlignCenterHorizontalSimpleIcon(props: IconProps): JSX.Element {
