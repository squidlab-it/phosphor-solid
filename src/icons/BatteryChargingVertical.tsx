...
/**
 * BatteryChargingVertical icon component.
 *
 * @example
 * ```tsx
 * <BatteryChargingVerticalIcon weight="regular" />
 * ```
 */
export function BatteryChargingVerticalIcon(rawProps: IconProps): JSX.Element {
