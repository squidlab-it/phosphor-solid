...
/**
 * AlignCenterVerticalSimple icon component.
 *
 * @example
 * ```tsx
 * <AlignCenterVerticalSimpleIcon weight="regular" />
 * ```
 */
export function AlignCenterVerticalSimpleIcon(props: IconProps): JSX.Element {
