...
/**
 * BatteryWarningVertical icon component.
 *
 * @example
 * ```tsx
 * <BatteryWarningVerticalIcon weight="regular" />
 * ```
 */
export function BatteryWarningVerticalIcon(rawProps: IconProps): JSX.Element {
