...
/**
 * ArrowsCounterClockwise icon component.
 *
 * @example
 * ```tsx
 * <ArrowsCounterClockwiseIcon weight="regular" />
 * ```
 */
export function ArrowsCounterClockwiseIcon(rawProps: IconProps): JSX.Element {
