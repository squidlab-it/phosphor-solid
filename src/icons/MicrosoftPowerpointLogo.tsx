...
/**
 * MicrosoftPowerpointLogo icon component.
 *
 * @example
 * ```tsx
 * <MicrosoftPowerpointLogoIcon weight="regular" />
 * ```
 */
export function MicrosoftPowerpointLogoIcon(rawProps: IconProps): JSX.Element {
