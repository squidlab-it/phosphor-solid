...
/**
 * ArrowBendDoubleUpRight icon component.
 *
 * @example
 * ```tsx
 * <ArrowBendDoubleUpRightIcon weight="regular" />
 * ```
 */
export function ArrowBendDoubleUpRightIcon(rawProps: IconProps): JSX.Element {
