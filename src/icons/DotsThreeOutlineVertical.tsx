...
/**
 * DotsThreeOutlineVertical icon component.
 *
 * @example
 * ```tsx
 * <DotsThreeOutlineVerticalIcon weight="regular" />
 * ```
 */
export function DotsThreeOutlineVerticalIcon(rawProps: IconProps): JSX.Element {
