...
/**
 * CaretCircleDoubleRight icon component.
 *
 * @example
 * ```tsx
 * <CaretCircleDoubleRightIcon weight="regular" />
 * ```
 */
export function CaretCircleDoubleRightIcon(rawProps: IconProps): JSX.Element {
